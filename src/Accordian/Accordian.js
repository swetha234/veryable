...
const Accordian = (props) => {
    ...
    return  <div class="bodyOfContainer">
                <div class="bodyOfContainer-one">
                    <div class="userIcon">
                        <svg className={`role ${props.role}`} xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000">
                    ...
                    <div className="up-down" onClick={()=>{ShowHide()}}>
                        {
                        isTrue ? 
